        ...
        <div className="h-4/5 w-4/5 bg-white relative overflow-hidden rounded-lg">
            ...
            >
                ...
                >
                    <div
                        id="overlay-left"
                        className={`w-1/2 h-full absolute flex justify-center items-center top-0 transform transition transition-transform duration-700 ease-in-out ${isAnimated ? "translate-x-0" : "-translate-x-[20%]"
                            }`}
                    >
                        <SigninInvite
